        ...
        <div className="min-h-screen bg-black text-white pb-24 lg:pb-8 flex flex-col h-screen overflow-hidden">
            ...
            <main className="flex-1 relative overflow-hidden bg-[#050505]">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url("https://maps.googleapis.com/maps/api/staticmap?center=${mapCenter.lat},${mapCenter.lng}&zoom=6&size=1200x800&maptype=satellite&key=YOUR_API_KEY_HERE")`,
