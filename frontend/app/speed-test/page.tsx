            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl">
                    ...
                    <div className={`p-6 border ${status === 'testing_download' ? 'border-white bg-[#ffffff05]' : 'border-[#1a1a1a] bg-[#0a0a0a]'} transition-all`}>
                        ...
                        <div className="text-3xl font-black">{status === 'idle' ? '-' : downloadSpeed}<span className="text-sm text-gray-500 ml-1">Mbps</span></div>
                    </div>
                    ...
                    <div className={`p-6 border ${status === 'testing_upload' ? 'border-white bg-[#ffffff05]' : 'border-[#1a1a1a] bg-[#0a0a0a]'} transition-all`}>
                        ...
                        <div className="text-3xl font-black">{status === 'idle' || status === 'testing_download' ? '-' : uploadSpeed}<span className="text-sm text-gray-500 ml-1">Mbps</span></div>
                    </div>
                    ...
                    <div className="p-6 border border-[#1a1a1a] bg-[#0a0a0a]">
                        ...
                        <div className="text-3xl font-black">{status === 'idle' ? '-' : '24'}<span className="text-sm text-gray-500 ml-1">ms</span></div>
                    </div>
                </div>
